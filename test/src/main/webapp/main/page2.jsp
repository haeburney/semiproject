...
<div class="carousel-indicators">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="${pageContext.request.contextPath }/submain/populer.do">
    ...
    <div class="carousel-item">
      <a href="${pageContext.request.contextPath }/submain/toprate.do">
    ...
    <div class="carousel-item">
      <a href="${pageContext.request.contextPath }/submain/upcoming.do">
