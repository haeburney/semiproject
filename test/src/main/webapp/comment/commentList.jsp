...
<body>
					...
					<div class="other_item">
						<table style="width: 100%;">
							<tr>
								...
								<td width="50%">
									<div align="right">
										<div id="good_area_best" class="good_area" align="right"> 
											<span class="good_name">좋아요</span><img class="img_good" src="../image/thumbs-up.png" />
											<div class="good_num" align="right">
												<div class="slash">|</div>
												<div style="width: 40px;">
					...
					<div class="other_item">
						<table style="width: 100%;">
							<tr>
								...
								<td width="50%">
									<div align="right">
										<div id="good_area_recent" class="good_area" align="right"> 
											<span class="good_name">좋아요</span><img class="img_good" src="../image/thumbs-up.png" />
											<div class="good_num" align="right">
												<div class="slash">|</div>
												<div style="width: 40px;">
					...
					<div class="other_item">
						<table style="width: 100%;">
							<tr>
								...
								<td width="50%">
									<div align="right">
										<div id="good_area_spoiler" class="good_area" align="right"> 
											<span class="good_name">좋아요</span><img class="img_good" src="../image/thumbs-up.png" />
											<div class="good_num" align="right">
												<div class="slash">|</div>
												<div style="width: 40px;">
	...
	<script>
		...
		// 인기순 좋아요
		var best_cnt = 0;
		var best_rate_userId = $('#good_best_rate_userId').text();
		$('#good_area_best').click(function() {
			best_cnt = $('#good_best').text();
			best_cnt++;
			$('#good_best').text(best_cnt);
			var index = best_rate_userId.split(':')[1];
			var userId = best_rate_userId.indexOf(index);
		...
		// 최신순 좋아요
		var recent_cnt = $('#good_recent').text();
		var recent_rate_userId = $('#good_recent_rate_userId').text();
		$('#good_area_recent').click(function() {
			recent_cnt + 1;
			$('#good_recent').text(recnet_cnt);
			var index = recent_rate_userId.split(':')[1];
			var userId = recent_rate_userId.indexOf(index);
		...
		// 스포일러 좋아요
		var spoiler_cnt = $('#good_spoiler').text();
		var spoiler_rate_userId = $('#good_spoiler_rate_userId').text();
		$('#good_area_spoiler').click(function() {
			spoiler_cnt++;
			$('#good_spoiler').text(spoiler_cnt);
			var index = spoiler_rate_userId.split(':')[1];
			var userId = spoiler_rate_userId.indexOf(index);
